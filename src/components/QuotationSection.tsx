  ...
  return (
    <div className="quotation-section-isolated">
      ...
      <div className="quotation-main-box">
        <h2 className="quotation-title" style={{color: 'white', fontWeight: 'bold', margin: '0'}}>예상 견적</h2>
        <h2 className="quotation-price" style={{color: 'white', fontWeight: 'bold', margin: '0'}}>{totalPrice.toLocaleString()}원</h2>
      </div>
