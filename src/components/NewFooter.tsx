      ...
      <footer className="bg-white text-gray-900 pt-2 pb-8 border-t border-gray-100">
        ...
        <div className="flex flex-col md:flex-row items-end md:items-start w-full md:w-auto gap-4 md:gap-8 mt-6">
          ...
          <motion.a
            ...
            whileTap={{ scale: 0.98 }}
            className="hidden md:flex justify-center items-center text-center bg-[#272929] text-white hover:text-white px-6 py-5 rounded-lg font-bold text-lg transition-all duration-300 mt-6"
          >
            서비스 신청
          </motion.a>
